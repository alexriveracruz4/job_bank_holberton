...
function ItemStudent(props) {
  ...
  if (props.photo != null && props.photo != undefined){
    photo = `${apiPath}/student_photos/${props.photo}`;
  }

  return (
    <React.StrictMode>     
        <Link to={{ pathname:`/estudiante/puestos-de-trabajo/partners/${props.id}`}} style={{ color: 'inherit', textDecoration: 'inherit'}}> 
...
marginRight: '25px'}}>
                      ...
                      <Box
                      >
                        <a class="MuiTypography-root MuiTypography-h6 MuiTypography-alignLeft" style={{color: 'inherit', display: 'block', textDecoration: 'none', cursor: 'pointer', lineHeight: '1.7rem', marginBottom: '0.3rem', textAlign: 'left', fontSize: '1.25rem', fontWeight: '500'}} rel="noopener" href=""> {props.firstname} {props.lastname}</a>
